...
The current `main` checkpoint materially improved one hundred and fifteen areas:
...
| Metric | Value |
|--------|-------|
| Full suite result | `1467 passed, 13 skipped, 12 xfailed, 16 xpassed` |
...
| **CI pipeline** | **Enforced** | GitHub Actions runs lint, matrix tests, build, and the fast LLM acceptance gate on every push. Local full gate currently `1467 passed, 13 skipped, 12 xfailed, 16 xpassed`; check Actions for the latest branch conclusion. |
