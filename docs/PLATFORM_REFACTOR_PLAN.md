...
| `core/task_router.py` | 1053 | task classification, typed envelope emission, and route-level model constraints now converge here; keep it as the one place that turns user input into lane hints instead of cloning route heuristics across surfaces |
