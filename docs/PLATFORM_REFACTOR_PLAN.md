...
| `core/brain_hive_service.py` | 693 | service boundary is materially thinner after the read/query, commons-promotion, and review-workflow extractions, but topic/post mutation lifecycle logic is still too mixed |
