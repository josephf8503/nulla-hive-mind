...
| `apps/nulla_agent.py` | 3486 | still the main runtime composition root and a top remaining blast-radius center |
...
- `apps/nulla_agent.py` is down to 3486 lines from the older 11k+ state
